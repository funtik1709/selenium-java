...
public class TestExamples extends BaseTest {
    ...
    @Test(priority = 2, description = "Nav Test", groups="header")
    ...
    @Test(priority = 3, description = "Info Block", groups="header")
    ...
    @Test(priority = 4, description = "Header Title And Logo Test", groups="Body Test")
    ...
    @Test(priority = 5, description = "Developer Site", groups="Body Test")
    ...
    @Test(priority = 6, description = "Download App", groups="Body Test")
